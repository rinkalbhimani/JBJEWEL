...
$sql = "INSERT INTO feedback (f_nm, f_email,f_no,f_msg) VALUES ('$name','$email','$no','$message')";
                    ...
                    <div class="contact-form-right">
                        ...
                        <form action="#" method="POST" >
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Your Mobile_No" maxlength="10" class="form-control" name="mobno" required data-error="Please enter your Mobile No.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
