...
<br><br>
 <table class="table ">
    ...
    <tr>
      ...
      <!-- <td><button class="btn btn-primary" style="height:40px" onclick="itemEditForm(">Edit</button></td> -->
      <!-- <td><button class="btn btn-danger"  name="del" style="height:40px" onclick="itemDelete('>')">Delete</button></td> -->
      <!-- <td><button class="btn btn-danger"  name="del" style="height:40px" onclick="itemDelete('>')">Delete</button></td> -->
      <td><button type="submit" name="submit" class="btn btn-danger" style="height:40px"><a href="DeleteContact.php?CID=<?=$row['c_id']?>">Delete</button></td>
      </tr>
      <?php
            $count=$count+1;
          }
