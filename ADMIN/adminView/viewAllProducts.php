...
<div >
  ...
  <table class="table ">
    ...
    <?php
      ...
      $sql="SELECT * from product, category WHERE product.c_id=category.c_id";
    ...
    <tr>
      <td><?=$count?></td>
       <td><img height='100px' src='<?=$row["p_image"]?>'></td> 
      <td><?=$row["p_nm"]?></td>
      <!-- <td><?=$row["p_qty"]?></td> -->
      <td><?=$row["cat_nm"]?></td> 
      <td><?=$row["p_price"]?></td>     
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' onsubmit="addItems()" method="POST">
            ...
            <!-- <div class="form-group">
              ...
              <input type="text" class="form-control" id="p_qty" required>
            </div> -->
            <div class="form-group">
