...
include_once "./config/database.php";
 ...
 <table class="table ">
    ...
    <tr>
      ...
      <td><button class="btn btn-primary" style="height:40px" onclick="itemEditForm('<?=$row['f_id']?>')">Edit</button></td>
      <!-- <td><button class="btn btn-danger"  name="del" style="height:40px" onclick="itemDelete('>')">Delete</button></td> -->
      <!-- <td><button class="btn btn-danger"  name="del" style="height:40px" onclick="itemDelete('>')">Delete</button></td> -->
      <td><a href="DeleteFeedback.php" ><button type="submit" name="submit" class="btn btn-danger"  style="height:40px" onclick="itemDelete('<?=$row['f_id']?>')"> Delete</button></a></td>
      </tr>
      <?php
            $count=$count+1;
          }
